const window.LANG_EN_APPSTORE = {
    ...
    ADD_STORE_URL_PLACEHOLDER: "Add a valid Polygol App Store inventory URL",
    ADD_STORE_BTN: "Add Store",
    STORE_ADDED_SUCCESS: "App store added successfully",
    LOADING_STORE_ERROR: "Error loading store:",
...
const window.LANG_JP_APPSTORE = {
    ...
    ADD_STORE_URL_PLACEHOLDER: "有効なPolygolアプリストアのインベントリURLを追加してください",
    ADD_STORE_BTN: "ストアを追加",
    STORE_ADDED_SUCCESS: "アプリストアが正常に追加されました",
    LOADING_STORE_ERROR: "ストアの読み込み中にエラーが発生しました：",
...
const window.LANG_DE_APPSTORE = {
    ...
    ADD_STORE_URL_LABEL: "App Store URL",
    ADD_STORE_URL_PLACEHOLDER: "Gültige Polygol App Store Inventar-URL hinzufügen",
    ADD_STORE_BTN: "Store hinzufügen",
    STORE_ADDED_SUCCESS: "App Store erfolgreich hinzugefügt",
    LOADING_STORE_ERROR: "Fehler beim Laden des Stores:",
    SEARCH_PLACEHOLDER: "Suchen",
    LOADING_APPS: "Apps werden geladen...",
...
const window.LANG_ES_APPSTORE = {
    ...
    ADD_STORE_URL_PLACEHOLDER: "Añadir una URL de inventario de tienda de aplicaciones de Polygol válida",
    ADD_STORE_BTN: "Añadir tienda",
    STORE_ADDED_SUCCESS: "Tienda de aplicaciones añadida con éxito",
    LOADING_STORE_ERROR: "Error al cargar la tienda:",
    SEARCH_PLACEHOLDER: "Buscar",
    LOADING_APPS: "Cargando aplicaciones...",
...
const window.LANG_KO_APPSTORE = {
    ...
    ADD_STORE_URL_PLACEHOLDER: "유효한 Polygol 앱 스토어 인벤토리 URL 추가",
    ADD_STORE_BTN: "스토어 추가",
    STORE_ADDED_SUCCESS: "앱 스토어가 성공적으로 추가되었습니다",
    LOADING_STORE_ERROR: "스토어 로드 오류:",
...
const window.LANG_ZH_APPSTORE = {
    ...
    ADD_STORE_URL_PLACEHOLDER: "添加一个有效的Polygol应用商店库存URL",
    ADD_STORE_BTN: "添加商店",
    STORE_ADDED_SUCCESS: "应用商店已成功添加",
    LOADING_STORE_ERROR: "加载商店时出错：",
    SEARCH_PLACEHOLDER: "搜索",
    LOADING_APPS: "正在加载应用...",
    NO_APPS_FOUND: "未找到任何应用"
};
